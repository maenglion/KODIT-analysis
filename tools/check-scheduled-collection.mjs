...
// The v0.6 public read model intentionally exposes only approved publish RPCs.
// Collection scheduling remains server-side and is not inferred in the public UI.
assert.doesNotMatch(ui, /public_collection_state/);
