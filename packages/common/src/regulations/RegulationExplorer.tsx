...
import { filterRegulations, rowsToCsv, statusOrder, validOfficialUrl, type RegulationFilters, type RegulationRow } from "./index";
  ...
  return <>
    ...
    <main className="regulations-shell shell">
      ...
      <section className="table-panel">
        ...
        <div className="table-scroll"><table className="regulations-table"><thead><tr>{["규정명","공개상태","현행 여부","문서검증 상태","미공개 검증단계","공식출처 수","엔진 검증 수","최근 수집일","최근 검증일"].map((h) => <th key={h}>{h}</th>)}</tr></thead>
